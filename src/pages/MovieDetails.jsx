  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white p-4">
      <div className="max-w-3xl bg-gray-800 rounded-lg shadow-lg p-6 text-center">
        ...
        <img
          src={movie.thumbnail || "https://via.placeholder.com/300x450"}
...
//           </span>
//         </div>
//         <Link to="/" className="inline-block mt-6 bg-red-500 hover:bg-red-600 px-6 py-2 rounded-lg shadow-md text-lg font-semibold">
//           ⬅ Back to Movies
//         </Link>
//       </div>
//     </div>
